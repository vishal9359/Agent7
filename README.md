# Agent7: LLM-Assisted C++ Program Understanding Agent
...
The executable `agent7` (or `agent7.exe` on Windows) will be generated in the build directory.

## 📖 Usage

```bash
./agent7 <cfg_json_file> <description_json_file> [callgraph_json_file]
```

### Example

```bash
./agent7 ../example_cfg.json ../example_description.json ../example_callgraph.json
```
